...
In the [first installment](/blog/from-their-repository-to-your-cluster/), we discussed how to select a tool and what considerations to take into account when choosing a tool. Now it's time to get to work and make it happen.
...
After choosing a project in [part 1](/blog/from-their-repository-to-your-cluster/), we've now automated the build and publishing process. Publishing updated Docker images to the repository of our choice is now as simple as adding a tag in GitHub.
